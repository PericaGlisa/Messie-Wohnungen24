        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-2xl font-bold text-gray-900 mb-8">AGB – Allgemeine Geschäftsbedingungen</h2>
              
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">1. Geltungsbereich</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">2. Vertragspartner</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">3. Vertragsschluss</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">4. Leistungen</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">5. Preise und Zahlung</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">6. Rücktritt / Stornierung</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">7. Haftung</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">8. Eigentumsvorbehalt</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">9. Datenschutz</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">10. Schlussbestimmungen</h3>
                  <p className="text-gray-700 leading-relaxed">
